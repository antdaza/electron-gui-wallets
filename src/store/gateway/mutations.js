...
export const set_article_status = (state, data) => {
  state.article_status = objectAssignDeep.noMutate(state.article_status, data);
};

export const set_article_list = (state, data) => {
  state.articles = objectAssignDeep.noMutate(state.articles, data);
};

export const set_article_search_results = (state, data) => {
  state.article_search = objectAssignDeep.noMutate(state.article_search, data);
}
