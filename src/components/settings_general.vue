  ...
  <div class="settings-general">
    ...
    <template v-if="config_daemon.type != 'local'">
      <div class="row q-mt-md pl-sm">
        <AntdField class="col-8" :label="$t('fieldLabels.remoteNodeHost')">
          <q-input
        ...
        <AntdField class="col-4" :label="$t('fieldLabels.remoteNodePort')">
          <q-input
    ...
    <div class="col q-mt-md pt-sm">
      <AntdField :label="$t('fieldLabels.dataStoragePath')" disable-hover>
        <q-input
      ...
      <AntdField :label="$t('fieldLabels.walletStoragePath')" disable-hover>
        <q-input
    ...
    >
      <div class="row pl-sm q-mt-sm">
        ...
        <AntdField class="col-6" :label="$t('fieldLabels.walletLogLevel')">
          <q-input
      ...
      <div class="row pl-sm q-mt-md">
        ...
        <AntdField class="col-3" :label="$t('fieldLabels.internalWalletPort')">
          <q-input
