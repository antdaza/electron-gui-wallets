  ...
  receive(message) {
    ...
    switch (decrypted_data.event) {
      ...
      case "set_article_status": {
        ...
        // Handle nested status objects like publish, metadata, etc.
        for (const key in data) {
          if (data[key].i18n) {
            data[key].message = this.geti18n(data[key].i18n);
          }
        ...
        this.app.store.commit("gateway/set_article_status", data);
        break;
      }
      ...
      case "article_published": {
        ...
        this.app.store.commit("gateway/set_article_status", {
          publish: {
            code: 0,
            ...data
          }
