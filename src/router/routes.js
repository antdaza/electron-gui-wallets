export default [
  ...
  // Add new article routes
      {
        path: "articles",
        component: () => import("pages/wallet/articles"),
        children: [
          {
            path: "",
            redirect: { name: "articles-browse" }
          },
          {
            path: "browse",
            name: "articles-browse",
            component: () => import("components/article/ArticleBrowse")
          },
          {
            path: "publish",
            name: "articles-publish",
            component: () => import("components/article/ArticlePublish")
          },
          {
            path: ":txHash",
