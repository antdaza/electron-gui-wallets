export default {
  buttons: {
    ...
    purchase: "PURCHASE",
    receive: "RECEIVE",
    registerFullNode: "REGISTER SERVICE NODE",
    renew: "RENEW",
    rescan: "RESCAN",
  ...
  fieldLabels: {
    ...
    fullNodeCommand: "SERVICE NODE COMMAND",
    fullNodeKey: "SERVICE NODE KEY",
  ...
  strings: {
    ...
    antdAccumulatedRewards: "Accumulated rewards",
    antdUnlockedBalance: "Unlocked balance",
    antdUnlockedShort: "Unlocked",
    me: "Me",
    ...
    registrationStakingMigrationAntdToSessionToken:
      "Registration and staking into new Full Nodes is disabled due to the ongoing migration of Antd to Session Token. Read more here: ",
